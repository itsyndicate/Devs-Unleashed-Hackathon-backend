...
SECRET_KEY = 'django-insecure-d!u7)^l!h^28l^z05!a_ef+e@=z6*6uhll66m9olfb+fywj8m^'
...
WSGI_APPLICATION = 'taskogotchi.wsgi.application'
ASGI_APPLICATION = "taskogotchi.asgi.application"
